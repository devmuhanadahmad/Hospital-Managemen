...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{__("Section")}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example2">
                                            ...
                                            <tr>
                                                ...
                                                <th class="wd-20p border-bottom-0">{{__('Created at')}}</th>
                                                <th class="wd-20p border-bottom-0">{{__('Processes')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
